        ...
        const outputSchema = `Return ONLY a JSON object (no markdown, no explanation):
{
  ...
  "ideas": [
    {
      "title": "SEO-optimized product title, max 60 characters. MUST include the primary keyword(s) that the target audience actually searches for on Amazon (e.g. 'Dog Mom Gift', 'Funny Nurse', 'Retirement Gift for Men'). Do NOT include: brand names, trademarked terms, copyrighted characters/slogans/IPs protected in the United States, or generic product type words such as T-Shirt, Tee, Shirt, Top, Apparel, Clothing",
